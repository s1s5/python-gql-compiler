...
from ..queries.union.query_typeddict import GetUnion
...
class TestRequest(LocalSchemaTest, unittest.IsolatedAsyncioTestCase):
    def test_sync_get(self):
        ...
        self.assertEqual(result_1, {"search": [{"__typename": "Human", "totalCredits": 3}]})
        result_1 = GetUnion.execute(self.client, {"text": "R2"})
        self.assertEqual(
            result_1, {"search": [{"__typename": "Droid", "friends": [{"name": "luke"}, {"name": "C-3PO"}]}]}
        )
